...
app.post('/transaction/broadcast', function (req, res) {
	...
	const fertilizerType="45-55-40"
	// Logic
	
	 const fertilizerType = function getFertType(npk) {
		const fertType = "Particular Fertilizer Not Available" 
      ...
      if(K<1)  var r3= 1-K 
		...
		if(r1==0 && r2==0 && r3==0) fertType="NPK Values are ideal,No fertilizer required"
		if(r1<r2 && r1<r3 ) fertType="Urea(46:0:0)"
		if(r2<r1 && r2<r3) fertType="Di-Ammonium Phosphate(DAP)"
		if(r3<r1 && r3<r2) fertType="Murate of Potash(M.O.P)"
		if(r1==r2 && r3==0) fertType="20:20:0"
	    if(((r1-r2)<=0.2) && r3==0) fertType="28:28:0"
	    if(((r1-r2)<=0.2)&&((r2-r3)<=0.2)) fertType="16:16:16"
	    if(((r1-r2)<=0.3)&&((r2-r3)<=0.3)) fertType="17:17:17"
